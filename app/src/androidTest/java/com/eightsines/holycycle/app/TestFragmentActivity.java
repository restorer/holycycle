...
public class TestFragmentActivity extends FragmentActivity {
    ...
    private String mode;
    private ViewControllerFragment fragment;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (MODE_EMBEDDED.equals(mode)) {
            setContentView(R.layout.test_fragment_support);
            fragment = (ViewControllerFragment)getSupportFragmentManager().findFragmentById(R.id.fragment);
        ...
        if (savedInstanceState == null) {
            fragment = ViewControllerFragmentStub.newInstance();
            getSupportFragmentManager().beginTransaction().replace(R.id.container, fragment, FRAGMENT_TAG).commit();
        } else {
            fragment = (ViewControllerFragment)getSupportFragmentManager().findFragmentByTag(FRAGMENT_TAG);
        }
    }
